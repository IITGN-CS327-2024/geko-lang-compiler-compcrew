...
if __name__ == '__main__':
    ...
    print(AStree)
    # Output:
    # CodeBlock(statements=[SetVar(name='a', value=Value(meta=Meta(line=1, pos_in_stream=0, end_line=1, end_column=5), value=1)), If(cond=Value(meta=Meta(line=2, pos_in_stream=8, end_line=2, end_column=9), value=Name(name='a')), then=CodeBlock(statements=[Print(value=Value(meta=Meta(line=3, pos_in_stream=20, end_line=3, end_column=31), value='a is 1')), SetVar(name='a', value=Value(meta=Meta(line=4, pos_in_stream=44, end_line=4, end_column=49), value=2))]))])
