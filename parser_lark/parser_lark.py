...
parameter	:	(basic_data_type | compund_data_type) IDENTIFIER | array
...
basic_data_type	:	( FIX | epsilon ) (NUM | STR | FLAG)
compound_data_type	:	LIST | TUP
expressions	:	ELEMENT_SEPERATOR expression expressions | epsilon
expression	:	term terms | epsilon
terms	:	(BINARY_OPERATOR | COMPARISON_OPERATOR | BINARY_LOGICAL_OPERATOR) term terms | epsilon
term	:   IDENTIFIER
| NUM_LITERAL
| string
| FLAG
| OPEN_PARENTHESIS expression CLOSE_PARENTHESIS
| (UNARY_OPERATOR | UNARY_LOGICAL_OPERATOR) IDENTIFIER
| IDENTIFIER UNARY_OPERATOR
block	:	OPEN_BRACES statements CLOSE_BRACES
assignment_operators	:	EQUAL_TO | ASSIGNMENT_OPERATOR
variable_declaration	:	basic_data_type IDENTIFIER (EQUAL_TO expression | epsilon)
| (compound_data_type IDENTIFIER | array) (EQUAL_TO OPEN_BRACKET expression expressions CLOSE_BRACKET | epsilon)
...
conditional_statement	:	GIVEN OPEN_PARENTHESIS expression CLOSE_PARENTHESIS block
   other_block (OTHERWISE block | epsilon)
...
slice_string	:	(str | epsilon) IDENTIFIER EQUAL_TO IDENTIFIER OPEN_BRACKET NUM_LITERAL SLICING_COLON NUM_LITERAL CLOSE_BRACKET
...
let_in_statement	:	LET (data_type | epsilon) IDENTIFIER ASSIGNMENT_OPERATOR term END_OF_LINE
